...
LOG_FILE="/tmp/log/cmd_lua	.log"
PRINTLOGGER="/usr/sbin/axell/common/current/sys/printlogger"
...
function runaxsh(cmd)
   ...
   os.execute("chmod 600 " .. LOG_FILE)
   os.execute(PRINTLOGGER .." ".. LOG_FILE .."1 1000 255 3 " .. cmd )
