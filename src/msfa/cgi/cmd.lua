...
--- the tapper_mode command
defineCommand('tapper_mode', function (params)
   return runbin('/usr/sbin/axell/target/current/cmd/tapper_mode.sh '..params)
end)

--- the tapperMon command
defineCommand('tapperMon', function (params)
   return runbin('/usr/sbin/axell/target/current/cmd/tapper_v3_mon.sh '..params)
end)

--- the 2io14o command
defineCommand('twoFourteen', function (params)
   return runbin('/usr/sbin/axell/target/current/cmd/tapper_v3_sys_2io14o.sh '..params)
end)

--- the 4io12o command
defineCommand('fourTwelve', function (params)
   return runbin('/usr/sbin/axell/target/current/cmd/tapper_v3_sys_4io12o.sh '..params)
end)
...
--- the MSFA command
defineCommand('msfa_unit', function (params)
   return runbin('/usr/sbin/axell/target/current/cmd/msfa_unit '..params)
end)

--- the MSFA command
defineCommand('msfa_settings', function (params)
   return runbin('/usr/sbin/axell/target/current/cmd/msfa_settings '..params)
end)
...
defineCommand('fpga_config',function ( params )
    return runbin('/mnt/axell/sbin/target/current/sys/hw_init/fpga_config.sh '..params)
end)

defineCommand('measurements',function ( params )
    return runbin('/usr/sbin/axell/target/current/cmd/measurements '..params)
end)
...
defineCommand('msfastatus', function (params)
	return runbin('/usr/sbin/axell/target/current/cmd/msfastatus '..params)
end)
